...
public class RequestPrinter {
  ...
  public static String debugString(HttpServletRequest request, boolean printSession) {
    ...
    sb.append("<strong>PATH TRANSLATED:</strong> ")
  ...
  private static String debugStringCookies(HttpServletRequest request, int indent) {
    ...
    for (Cookie cookie : request.getCookies()) {
      sb.append(RequestPrinter.debugStringCookie(cookie, indentString + INDENT_UNIT))
          .append(NEWLINE_SEPERATOR);
      cookieCount++;
    }
    if (cookieCount > 0) {
  ...
  private static String debugStringHeader(
      String indentString, String headerName, List<String> headerValues) {
    StringBuilder sb = new StringBuilder();
  ...
  private static String debugStringHeaders(HttpServletRequest request, int indent) {
    ...
    while (headerNames.hasMoreElements()) {
      ...
      sb.append(RequestPrinter.debugStringHeader(indentString, headerName, headerValuesList))
          .append(",\n");
    }
    sb.append(indentString).append("}\n");
    return sb.toString();
  ...
  private static String debugStringParameter(
      String indentString, String parameterName, String[] parameterValues) {
    StringBuilder sb = new StringBuilder();
  ...
  private static String debugStringParameters(HttpServletRequest request, int indent) {
    ...
    while (parameterNames.hasMoreElements()) {
      ...
      sb.append(RequestPrinter.debugStringParameter(indentString, parameterName, parameterValues))
          .append(",\n");
    }
    sb.append(indentString).append("}\n");
    return sb.toString();
  ...
  private static String debugStringSession(HttpSession session, int indent) {
    ...
    sb.append(indentString)
        .append(INDENT_UNIT)
        .append("'last_accessed_time': ")
        .append(session.getLastAccessedTime())
        .append(", \n");
    sb.append(indentString)
        .append(INDENT_UNIT)
        .append("'max_inactive_interval': ")
