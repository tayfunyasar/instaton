...
public enum SocialSignInProvider {
	...
	Twitter("twitter"), Facebook("facebook"), LinkedIn("linkedin"), GitHub("github"), Google("google");
	...
	public static Optional<SocialSignInProvider> getForProviderId(String providerId) {
		return Stream.of(values()).filter(it -> it.providerId.equals(providerId)).findFirst();
	}
}
